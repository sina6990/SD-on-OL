...
def set_logging(args, description):
    ...
    json_filename = log_path + '/' + description + '_' + model_short_name + '_' + data + '_Last_' + run_id + '.json'
    log_filename = log_path + '/' + description + '_' + model_short_name + '_' + data + '_Last_' + run_id + '.log'
