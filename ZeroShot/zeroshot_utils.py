...
def parse_args():
    ...
    parser.add_argument('--num_of_samples', type=int, default=100, help='Number of samples in the dataset')
    ...
    parser.add_argument('--task', type=str, default='hatespeech', help='Detection task (e.g., hatespeech, sarcasm, humor)')
